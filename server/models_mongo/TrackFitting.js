...
module.exports = new Schema({
  ...
  fuelConsumptionLiters: { type: Number },
  energyUsageKWh: { type: Number },
  maintenanceFrequencyPerYear: { type: Number },
  replacementCycles: { type: Number },
  equipmentLifespanYears: { type: Number },
  wasteGenerationKg: { type: Number },
  recyclabilityPercent: { type: Number },
  manufacturingEmissionsKgCO2: { type: Number },
  serviceLife: { type: Number },
